...
(function (racine) {
  ...
  class Depot {
    ...
    modifier(id, changements) {
      ...
      // Le doublon d'e-mail, en excluant le contact qu'on est en train de modifier.
    ...
    trier(liste, champ, croissant) {
      ...
      return liste.slice().sort(function (a, b) {
        ...
        // Les nombres se comparent par soustraction, les textes par localeCompare
        // — qui gère les accents, contrairement à une comparaison brute.
